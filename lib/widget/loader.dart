...
class _LoaderState extends State<Loader> with SingleTickerProviderStateMixin {
  ...
  Animation<double> animation_radias_in;
  Animation<double> animation_radias_out;
  ...
  void initState() {
    ...
    animation_radias_in = Tween<double>(
      begin: 1.0,
      end: 0.0,
    ).animate(CurvedAnimation(
        parent: controller,
    ...
    animation_radias_out = Tween<double>(
      begin: 0.0,
      end: 1.0,
    ).animate(CurvedAnimation(
        parent: controller,
    ...
    controller.addListener((){
      setState(() {
        if(controller.value >= 0.75 && controller.value <= 1.0){
          radius = animation_radias_in.value * initialRadius;
        }else if(controller.value >= 0.0 && controller.value <= 0.25){
          radius = animation_radias_out.value * initialRadius;
        }
      });
    });
    controller.repeat();
