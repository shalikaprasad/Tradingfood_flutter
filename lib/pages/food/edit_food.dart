...
class EditFoodPage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _EditFoodState(this.food);
  }
}
...
class _EditFoodState extends State<EditFoodPage> {
  ...
  void initState() {
    ...
    foodDiscount.text = food.discount.toString();
    foodRatings.text = food.ratings.toString();
  }
                ...
                Center(
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      if(foodname != null) {
                        showToast(foodname + " Edit Successfully");
                        Navigator.push(
                          context,
