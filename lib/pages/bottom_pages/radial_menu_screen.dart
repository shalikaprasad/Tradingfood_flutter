...
import 'package:trendingfood_flutter/widget/radial_menu/geometry.dart';
import 'package:trendingfood_flutter/widget/radial_menu/radial_menu_collisions.dart';

//void main() => runApp(new MyApp());

final MenuClass demoMenu = MenuClass(items: [
  new MenuItemList(
    id: "1",
    icon: Icons.home,
...
class RadialMenuApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new RadialMenuHomePage(),
    );
  }
}

class RadialMenuHomePage extends StatefulWidget {
  @override
  _RadialMenuHomePageState createState() => new _RadialMenuHomePageState();
}

class _RadialMenuHomePageState extends State<RadialMenuHomePage> {
  Widget _buildMenu() {
...
class _RadialMenuState extends State<RadialMenu> with SingleTickerProviderStateMixin {
  ...
  List<Widget> buildRadialBubbles() {
    ...
    return widget.menu.items.map((MenuItemList item) {
  ...
  Widget buildActivationRibbon() {
    ...
    final MenuItemList activeItem =
    widget.menu.items.firstWhere((MenuItemList item) => item.id == _menuController.activationId);
